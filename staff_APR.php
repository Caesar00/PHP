...
<?php
        ...
        ?>
<div class="leftmenu">
  <div class="box"> <a href="staff_APR.php?cont=APR">List of Pending APRs</a>
    <div class="line"></div>
    <a href="staff_APR.php?cont=submitted">List of Submitted APRs</a> </div>
</div>
<div style="float:right; width:80%;">
  ...
  if(isset($_GET['act']))
  {
	  if($_GET['act']=="view")
	  {
		  include "staff_view_APR.php";
	  }
	  else if($_GET['act']=="submit")
	  {
		  include "staff_submit_apr.php";
	  }
  }
  else
  {
