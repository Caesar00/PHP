...
if (isset($_SESSION['timeout'])) 
{
    ...
    if ($session_life > $inactive)
	{
        session_destroy();
        session_start();
        $_SESSION['info'] = "<strong>To continue, please login into your student account.</strong>";
...
<html>
    ...
    <body>
        ...
        if(isset($_GET['cont']))
        {
            if($_GET['cont'] == 'APR')
            {
                include "student_apr3.php";
            }
            
            if($_GET['cont'] == 'MLS')
            {
                include "student_mls3.php";
            }

            if($_GET['cont'] == 'RPM')
            {
                include "student_rpm3.php";
            }
        }
        else
        {
            include "student_profile3.php";
        }
        ?>
    </body>
</html>
