...
$query = "SELECT APR_NO,Std_NO,thesis_title,date_format(date_submitted,'%d-%m-%Y %k:%i:%s') as date_submitted,status FROM apr_a LIMIT $page,10;";
$result = mysqli_query($con,$query) or die(mysqli_error($con));
...
if(isset($_POST['param']))
{
	...
	if(mysqli_num_rows($result)==1)
	{
		...
		session_commit();
		header("Location: gro_index.php?cont=APR&act=view");
	}
}
session_commit();
?>
