<?php
    ...
    if (isset($_POST['ptime'])) {
        $ptime = strtotime($_POST['ptime']) - strtotime('TODAY');
    }
    ...
    if($result)
    {
        ...
        {
            $mail->Subject = "Your meeting log has been confirmed - HDR Murdoch University";
            $body = "<html><body>";
            $body .= "<br><font>Dear ".$student['firstname'].",</font>";
            $body .= "<br><p>We are glad to inform you that supervisor <strong>".$user['salutation']." ".$user['firstname']." ".$user['surname']."</strong> has just confirmed one of the meeting log #$meeting_id <br>You can log into the HDR system to view more detail.<br>Thank you for your cooperation.<br><br>";
        }
        else
        {
            $mail->Subject = "Your meeting log has been rejected - HDR Murdoch University";
            $body = "<html><body>";
            $body .= "<br><font>Dear ".$student['firstname'].",</font>";
            $body .= "<br><p>We are sorry to inform you that supervisor <strong>".$user['salutation']." ".$user['firstname']." ".$user['surname']."</strong> has just rejected one of your meeting log #$meeting_id due to <strong>'$comments'</strong>.<br><br>You can log into the HDR system to view more detail.<br></br>Thank you for your cooperation.<br><br>";
        }
...
<div class="container1">
    <div class="jumbotron"><p> Meeting Log has been updated successfully.
    <p class="buttons"> <a href="staff_index3.php?cont=MLS">Back to Meeting Logs</a> </p>
</div>
